...
- Implementar clientes reales, todo se ve desde la vista de administrador.
- Retiro y depósito vista admin, no existe la vista cliente.
- Falta probar fallo de depósitos.
- No existen clientes con cuentas en múltiples paises.
- Cada banco tiene 3 cuentas, deberían ser clientes reales.
